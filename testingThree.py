...
# model.save('exercisesaction3.h5')
# model = load_model('exercisesaction3.h5')
...
cap = cv2.VideoCapture('resources/pushup3.mp4')
...
with mp_holistic.Holistic(min_detection_confidence=0.7, min_tracking_confidence=0.7) as holistic:
    ...
    while True:
        ...
        cv2.putText(img, (actions[np.argmax(res)]), (3, 20),
