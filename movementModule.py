...
class poseDetector():
    ...
    def Angle(self, img,p1,p2,p3,draw = True):
        ...
        if draw:
            cv2.line(img,(x1,y1),(x2,y2),(0,0,255),3) #draw line
            cv2.line(img, (x3, y3), (x2, y2), (0, 0, 255), 3) #draw line
            ...
            #cv2.putText(img, str(int(angle)), (x2-100,y2+30), cv2.FONT_HERSHEY_PLAIN, 3,
               #         (200, 200, 0), 3)
        return angle
